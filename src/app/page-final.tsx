  ...
  const featuredMods = [
    {
      ...
      features: "Dynamic Entity Cleanup|Auto-Tuning System|+2 more",
      downloads: "15,420",
      rating: 4.9,
    ...
    },
    {
      ...
      features: "50+ Weapons|Custom Sounds|Realistic Physics",
      downloads: "12,850",
      rating: 4.8,
    ...
    },
    {
      ...
      features: "GUI Interface|Auto-Moderation|Player Management",
      downloads: "8,920",
      rating: 4.7,
    ...
    },
    {
      ...
      features: "Smart AI|Group Behavior|Dynamic Spawning",
      downloads: "11,200",
      rating: 4.6,
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white relative overflow-hidden">
      ...
      <div 
        ...
        style={{
          backgroundImage: `url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 400"><defs><radialGradient id="devilGlow" cx="50%" cy="50%" r="50%"><stop offset="0%" stop-color="%23dc2626"/><stop offset="100%" stop-color="%23991b1b"/></radialGradient></defs><circle cx="200" cy="150" r="50" fill="url(%23devilGlow)"/><path d="M175 125 Q200 110 225 125 Q215 140 200 145 Q185 140 175 125 Z" fill="%23dc2626"/><path d="M185 135 Q200 125 215 135" stroke="%23991b1b" stroke-width="3" fill="none"/><circle cx="190" cy="140" r="3" fill="%23fbbf24"/><circle cx="210" cy="140" r="3" fill="%23fbbf24"/><path d="M200 150 Q205 160 200 165 Q195 160 200 150" fill="%23dc2626"/><text x="200" y="250" text-anchor="middle" font-family="serif" font-size="24" font-weight="bold" fill="%23dc2626">THE DEVILS WISH</text></svg>')`
        }}
      />
              ...
              >
                ...
                <div className="flex mb-3">
                  {[...Array(testimonial.rating)].map((_, i) => (
                    <Star key={`star-${index}-${i}`} className="w-4 h-4 fill-yellow-400 text-yellow-400" />
                  ))}
                </div>
