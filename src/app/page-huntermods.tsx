...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {featuredMods.map((mod, index) => (
              <motion.div
                key={mod.id}
                className="bg-gray-800 rounded-lg overflow-hidden border border-gray-700 hover:border-red-500/50 transition-all duration-300 group"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
      ...
      {/* Footer */}
      <footer className="bg-gray-800 border-t border-red-900/20 py-8">
